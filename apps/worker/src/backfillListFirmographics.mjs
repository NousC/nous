...
// them; otherwise the SAME band-default the pipeline gave the other ~268
// companies (industry='agency', employee_count=10) — a default, not a measured
...
//   set -a; source ../../../assetly-blueprint/.env; set +a   # SUPABASE_URL + SERVICE_ROLE_KEY
