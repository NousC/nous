...
const SYSTEM_PROMPT = [
  ...
  "  5. If the user has the pipeline_stage claim set on meaningful subsets (you'll see it in a get_workspace_facts or query result), mention it too. Otherwise, present the activity-derived funnel as THE answer — don't apologise for missing pipeline_stage data.",
  "",
  "Rules:",
