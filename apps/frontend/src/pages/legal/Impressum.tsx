      ...
      {(t) => (
        <>
          ...
          <Section t={t} title="VAT Information">
            <p style={S.body(t)}>VAT ID (USt-IdNr.): <span style={{ color: t.text, fontFamily: "JetBrains Mono, monospace" }}>DE123456789</span> — according to § 27a UStG</p>
          </Section>

          <Section t={t} title="Responsible for Content (§ 55 Abs. 2 RStV)">
            <p style={S.body(t)}>Bennet Glinder · Dietrich-Schäfer-Straße 20, 28211 Bremen, Germany</p>
          </Section>
