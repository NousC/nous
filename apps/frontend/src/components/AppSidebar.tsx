...
export function AppSidebar({}: AppSidebarProps) {
  ...
  const renderNavItem = (item: { title: string; url: string; icon: React.ElementType }) => {
    ...
    const iconColor = active ? "text-gray-900" : "text-gray-800";
      ...
      <li key={item.title}>
        <NavLink
          ...
          className={`group flex w-full items-center rounded-lg px-2.5 py-1.5 transition-all duration-150 ${
            active ? "bg-gray-200/60" : "hover:bg-gray-100/70"
          }`}
          activeClassName=""
        >
          {content}
  ...
  return (
    <>
      <aside
        className={`flex-shrink-0 h-screen flex flex-col bg-[#FCFCFC] border-r border-gray-200/60 overflow-hidden transition-all duration-200 ${
      ...
      >
          ...
          <ul className="flex flex-col gap-0.5">
            ...
            <li>
              <a
                ...
                className="group flex w-full items-center rounded-lg px-2.5 py-1.5 transition-all duration-150 hover:bg-gray-100/70"
              >
                <div className="flex items-center gap-3">
                  <BookOpen
                    className="h-[17px] w-[17px] flex-shrink-0 text-gray-800 transition-colors group-hover:text-gray-900"
                    strokeWidth={1.75}
                  />
                  {!collapsed && (
        ...
        <div className="px-2.5 pb-3 pt-1">
          <div className="mx-1.5 mb-2 border-t border-gray-200/60" />
          <button
            onClick={() => navigate("/settings")}
            className={`group flex w-full items-center rounded-lg px-2.5 py-2 transition-all duration-150 hover:bg-gray-100/70 ${
              collapsed ? "justify-center" : "gap-2.5"
            } ${isItemActive("/settings") ? "bg-gray-200/60" : ""}`}
          >
            ...
            {!collapsed && (
              <span className="text-[13px] text-gray-700 group-hover:text-gray-900 truncate leading-tight transition-colors">
