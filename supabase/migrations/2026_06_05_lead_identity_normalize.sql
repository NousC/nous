...
-- trailing slash (…/in/georgi-furnadzhiev/) failed to match a scraped lead URL
-- without one (…/in/georgi-furnadzhiev) — spawning a DUPLICATE person entity
-- instead of merging into the existing contact. The LinkedIn engagement worker
-- hit this for every engager who was already a contact (e.g. Georgi).
--
